...
<body class=" vw-100">
    <form class="step-form">
        <section class="initial-step general-step vw-100 mt-5" id="initial-step">
            ...
            <div class="d-flex flex-column align-items-center gap-5  mx-auto" style="max-width: 800px;">
                ...
                <button type="submit" class="btn btn-primary mt-3 next-step">Submit</button>
            </div>
        </section>
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        initialStep.querySelector('button.next-step').addEventListener('click', function(e) {
            e.preventDefault();
            steps.length = 0;
